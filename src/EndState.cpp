...
EndState::EndState(StateData stateData):instruction("font/Call me maybe.ttf",20,Text::SOLID,"Voce venceu!",{255,255,255},0,Game::GetInstance().getHeight() - 40),music(),bg(){
